    ...
    <div className="min-h-screen">
        ...
        <div className="container-restaurant relative z-10 py-24">
          ...
          >
            ...
            <p className="text-lg text-background/70 max-w-lg mb-8 leading-relaxed">
              Experience handcrafted dishes made from fresh ingredients in a
              warm and welcoming atmosphere.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link
                to="/reservations"
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity"
              >
                Reserve Table <ArrowRight className="h-4 w-4" />
              </Link>
              <Link
                to="/menu"
                className="inline-flex items-center gap-2 px-7 py-3.5 border-2 border-background/30 text-background font-medium hover:bg-background/10 transition-colors"
              >
                View Menu
              </Link>
            </div>
      ...
      <section className="py-6 bg-primary text-primary-foreground">
        <div className="container-restaurant flex flex-wrap justify-center gap-8 md:gap-16">
          {[
            ...
            { icon: MapPin, text: "Douglas, Isle of Man" },
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Founded by Chef Marco Bellini, Yfeey Hub brings together the
                finest seasonal ingredients with techniques refined over two
                decades of culinary mastery.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Every dish tells a story — from our locally sourced produce to
                our house-made pastas and carefully curated wine selection.
              </p>
              <Link
                to="/about"
        ...
        <div className="container-restaurant">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-3 max-w-md mx-auto">
              Our most celebrated creations, crafted with passion and the finest
              ingredients.
            </p>
          </div>
          ...
          <div className="text-center mt-10">
            <Link
              to="/menu"
              className="inline-flex items-center gap-2 px-7 py-3 border-2 border-primary text-primary font-medium hover:bg-primary hover:text-primary-foreground transition-colors"
            >
      ...
      <section className="section-padding">
        <div className="container-restaurant">
          ...
          <div className="text-center mt-8">
            <Link
              to="/gallery"
              className="text-sm font-medium text-primary hover:text-accent transition-colors flex items-center gap-1 justify-center"
            >
        ...
        <div className="container-restaurant">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div
                key={t.id}
                className="bg-primary-foreground/5 backdrop-blur-sm p-6 border border-primary-foreground/10"
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 bg-accent/20 text-accent flex items-center justify-center text-xs font-bold">
                    {t.avatar}
                  </div>
                  <div>
      ...
      <section className="section-padding">
        <div className="container-restaurant text-center max-w-2xl">
          ...
          <Link
            to="/reservations"
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity"
          >
      ...
      <section className="section-padding bg-secondary">
        <div className="container-restaurant max-w-2xl text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Subscribe to receive special offers, seasonal menu updates, and
          ...
          >
            <input
              ...
              className="flex-1 px-5 py-3 bg-card text-foreground text-sm border border-border focus:outline-none focus:ring-2 focus:ring-accent/50"
              required
            />
            <button
              type="submit"
