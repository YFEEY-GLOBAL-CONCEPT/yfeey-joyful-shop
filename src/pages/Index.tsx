    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1600&q=80" alt="Restaurant ambiance" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-foreground/60" />
        </div>
        <div className="container-restaurant relative z-10 py-24">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-2xl">
            <span className="inline-block bg-accent/20 text-accent text-xs font-semibold px-4 py-1.5 mb-6 backdrop-blur-sm">
              Established 2018
            </span>
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/reservations" className="inline-flex items-center gap-2 px-7 py-3.5 bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity">
                Reserve Table <ArrowRight className="h-4 w-4" />
              </Link>
              <Link to="/menu" className="inline-flex items-center gap-2 px-7 py-3.5 border-2 border-background/30 text-background font-medium hover:bg-background/10 transition-colors">
                View Menu
              </Link>
            </div>
          </motion.div>
      ...
      <section className="section-padding">
        <div className="container-restaurant">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <img src="https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=700&q=80" alt="Chef preparing food" className="shadow-md" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-secondary">
        <div className="container-restaurant">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-display font-semibold text-foreground mt-2">Signature Dishes</h2>
            <p className="text-muted-foreground mt-3 max-w-md mx-auto">Our most celebrated creations, crafted with passion and the finest ingredients.</p>
          </div>
          ...
          <div className="text-center mt-10">
            <Link to="/menu" className="inline-flex items-center gap-2 px-7 py-3 border-2 border-primary text-primary font-medium hover:bg-primary hover:text-primary-foreground transition-colors">
      ...
      <section className="section-padding">
        <div className="container-restaurant">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-display font-semibold text-foreground mt-2">A Feast for the Eyes</h2>
          </div>
      ...
      <section className="section-padding bg-primary text-primary-foreground">
        <div className="container-restaurant">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div key={t.id} className="bg-primary-foreground/5 backdrop-blur-sm p-6 border border-primary-foreground/10">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 bg-accent/20 text-accent flex items-center justify-center text-xs font-bold">{t.avatar}</div>
                  <div>
      ...
      <section className="section-padding">
        <div className="container-restaurant text-center max-w-2xl">
          ...
          <h2 className="text-3xl sm:text-4xl font-display font-semibold text-foreground mt-2 mb-4">Book Your Table</h2>
          <p className="text-muted-foreground mb-8">Join us for an unforgettable dining experience. Reserve your table and let us take care of the rest.</p>
          <Link to="/reservations" className="inline-flex items-center gap-2 px-8 py-3.5 bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity">
      ...
      <section className="section-padding bg-secondary">
        <div className="container-restaurant max-w-2xl text-center">
          ...
          <p className="text-muted-foreground mb-8">Subscribe to receive special offers, seasonal menu updates, and exclusive event invitations.</p>
          <form className="flex gap-3 max-w-md mx-auto" onSubmit={(e) => { e.preventDefault(); toast.success("Thanks for subscribing! 🎉"); }}>
            <input type="email" placeholder="Enter your email" className="flex-1 px-5 py-3 bg-card text-foreground text-sm border border-border focus:outline-none focus:ring-2 focus:ring-accent/50" required />
            <button type="submit" className="px-6 py-3 bg-primary text-primary-foreground text-sm font-medium hover:opacity-90 transition-opacity">Subscribe</button>
          </form>
        </div>
      </section>
