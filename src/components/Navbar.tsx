    ...
    >
      <div className="container-restaurant flex items-center justify-between h-[var(--nav-height)]">
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/reservations"
            className="hidden sm:inline-flex px-5 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:opacity-90 transition-opacity"
          >
            Reserve Table
          </Link>
        ...
        {mobileOpen && (
          ...
          >
            <div className="container-restaurant py-4 flex flex-col gap-3">
              ...
              <Link
                to="/reservations"
                className="mt-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-full text-center"
              >
                Reserve Table
              </Link>
            </div>
